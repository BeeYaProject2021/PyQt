...
class Ui_MainWindow2(object):
    def setupUi(self, MainWindow2):
        ...
        self.conv2D_2 = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.conv2D_2.setGeometry(QtCore.QRect(30, 80, 81, 31))
        self.conv2D_2.setFrameShape(QtWidgets.QFrame.Panel)
        self.conv2D_2.setLineWidth(1)
        self.conv2D_2.setMidLineWidth(0)
        self.conv2D_2.setTextFormat(QtCore.Qt.AutoText)
        self.conv2D_2.setScaledContents(False)
        self.conv2D_2.setAlignment(QtCore.Qt.AlignCenter)
        self.conv2D_2.setObjectName("conv2D_2")
        self.maxpooling2D = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.maxpooling2D.setGeometry(QtCore.QRect(30, 150, 81, 31))
        self.maxpooling2D.setFrameShape(QtWidgets.QFrame.Panel)
        self.maxpooling2D.setTextFormat(QtCore.Qt.AutoText)
        self.maxpooling2D.setScaledContents(False)
        self.maxpooling2D.setAlignment(QtCore.Qt.AlignCenter)
        self.maxpooling2D.setObjectName("maxpooling2D")
        self.flatten_2 = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.flatten_2.setGeometry(QtCore.QRect(30, 220, 81, 31))
        self.flatten_2.setFrameShape(QtWidgets.QFrame.Panel)
        self.flatten_2.setTextFormat(QtCore.Qt.AutoText)
        self.flatten_2.setScaledContents(False)
        self.flatten_2.setAlignment(QtCore.Qt.AlignCenter)
        self.flatten_2.setObjectName("flatten_2")
        self.dense_2 = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.dense_2.setGeometry(QtCore.QRect(30, 290, 81, 31))
        self.dense_2.setFrameShape(QtWidgets.QFrame.Panel)
        self.dense_2.setTextFormat(QtCore.Qt.PlainText)
        self.dense_2.setScaledContents(False)
        self.dense_2.setAlignment(QtCore.Qt.AlignCenter)
        self.dense_2.setWordWrap(False)
    ...
    def retranslateUi(self, MainWindow2):
        ...
        self.conv2D_2.setText(_translate("MainWindow2", "conv2D"))
        self.maxpooling2D.setText(_translate("MainWindow2", "maxpooling2D"))
        self.flatten_2.setText(_translate("MainWindow2", "flatten"))
        self.dense_2.setText(_translate("MainWindow2", "dense"))
